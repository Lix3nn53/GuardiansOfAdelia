...
public class PaladinSkills {
    ...
    private static Skill getOne() {
        ...
        Skill skill = new Skill("Hammerblow", Material.ENCHANTED_BOOK, description, reqLevels, reqPoints, manaCosts, cooldowns);
    ...
    private static Skill getTwo() {
        ...
        Skill skill = new Skill("Heal", Material.ENCHANTED_BOOK, description, reqLevels, reqPoints, manaCosts, cooldowns);
    ...
    private static Skill getThree() {
        ...
        Skill skill = new Skill("Polymorph", Material.ENCHANTED_BOOK, description, reqLevels, reqPoints, manaCosts, cooldowns);
    ...
    private static Skill getPassive() {
        ...
        description.add("block the damage and revive.");
        ...
        Skill skill = new Skill("Resurrection", Material.ENCHANTED_BOOK, description, reqLevels, reqPoints, manaCosts, cooldowns);
    ...
    private static Skill getUltimate() {
        ...
        Skill skill = new Skill("Cosmic Radiance", Material.ENCHANTED_BOOK, description, reqLevels, reqPoints, manaCosts, cooldowns);
