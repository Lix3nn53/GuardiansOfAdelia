...
public class WeaponOffhand implements RPGGear {
    ...
    public WeaponOffhand(String name, ItemTier tier, String itemTag, Material material, int durability, int level, RPGClass rpgClass,
        ...
        lore.add(ChatColor.GRAY + "%60 when in offhand (" + offhandDamage + ")");
        ...
        this.itemStack = NBTTagUtils.putInteger("offhandDamage", offhandDamage, this.itemStack);
