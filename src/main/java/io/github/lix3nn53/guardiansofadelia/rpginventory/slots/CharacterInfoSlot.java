        ...
        if (GuardianDataManager.hasGuardianData(uuid)) {
            ...
            if (guardianData.hasActiveCharacter()) {
                ...
                skullMeta.setLore(new ArrayList() {{
                    ...
                    add(ChatColor.RED + "☄" + ChatColor.RED + " Fire: " + ChatColor.GRAY + fire.getBonusFromEquipment() + " + " + fire.getBonusFromLevel(level, rpgClass) + " + " + fire.getInvested());
                    add(ChatColor.BLUE + "◎ " + ChatColor.BLUE + "Water: " + ChatColor.GRAY + water.getBonusFromEquipment() + " + " + water.getBonusFromLevel(level, rpgClass) + " + " + water.getInvested());
                    add(ChatColor.DARK_GREEN + "₪ " + ChatColor.DARK_GREEN + "Earth: " + ChatColor.GRAY + earth.getBonusFromEquipment() + " + " + earth.getBonusFromLevel(level, rpgClass) + " + " + earth.getInvested());
                    add(ChatColor.AQUA + "ϟ " + ChatColor.AQUA + "Lightning: " + ChatColor.GRAY + lightning.getBonusFromEquipment() + " + " + lightning.getBonusFromLevel(level, rpgClass) + " + " + lightning.getInvested());
                    add(ChatColor.WHITE + "๑ " + ChatColor.WHITE + "Wind: " + ChatColor.GRAY + wind.getBonusFromEquipment() + " + " + wind.getBonusFromLevel(level, rpgClass) + " + " + wind.getInvested());
                }});
