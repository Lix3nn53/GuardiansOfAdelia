...
public class QuestsPhase7 {
    ...
    private static void createQuestOne() {
        ...
        Quest quest = new Quest(51, "Elderine", story,
    ...
    private static void createQuestTwo() {
        ...
        Quest quest = new Quest(52, "Fishing", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
    ...
    private static void createQuestThree() {
        ...
        List<ItemStack> itemPrizes = new ArrayList<>();
        String startMsg = ChatColor.YELLOW + "Click" + ChatColor.BOLD + " Compass Icon " + ChatColor.RESET + ChatColor.YELLOW + "from menu-book and select your destination NPC.";
        Quest quest = new Quest(53, "Vikings", story,
                startMsg, "Go to port city Elderine then talk with Captain Leanna",
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
    ...
    private static void createQuestFour() {
        ...
        List<Task> tasks = new ArrayList<>();
        TaskKill taskKill = new TaskKill(ChatColor.YELLOW + "Mummy", 20);
        tasks.add(taskKill);
        TaskKill taskKill2 = new TaskKill(ChatColor.YELLOW + "Ghost Mummy", 20);
        tasks.add(taskKill2);

        List<ItemStack> itemPrizes = new ArrayList<>();
        String objectiveText = "TASK_PROGRESS_1\nTASK_PROGRESS_2\nThen talk back to Pastry Chef Jasper";
        Quest quest = new Quest(54, "Wipe out the baddies", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
    ...
    private static void createQuestFive() {
        ...
        List<Task> tasks = new ArrayList<>();
        TaskKill taskKill = new TaskKill(ChatColor.YELLOW + "Ghost Spider", 20);
        tasks.add(taskKill);

        List<ItemStack> itemPrizes = new ArrayList<>();
        String objectiveText = "TASK_PROGRESS_1\nTASK_PROGRESS_2\nThen talk back to Pastry Chef Jasper";
        Quest quest = new Quest(55, "Wipe out the baddies", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
        QuestNPCManager.addQuest(quest, 43, 43);
    ...
    private static void createQuestSix() {
        ...
        nameOfMobsItemDropsFrom.add(ChatColor.YELLOW + "Desert Archer Skeleton");
        nameOfMobsItemDropsFrom.add(ChatColor.YELLOW + "Desert Cavalry Skeleton");
        ...
        Quest quest = new Quest(56, "Sugars with bad taste", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
        QuestNPCManager.addQuest(quest, 43, 43);
    ...
    private static void createQuestSeven() {
        ...
        TaskKill taskKill = new TaskKill(ChatColor.YELLOW + "Desert Archer Skeleton", 12);
        tasks.add(taskKill);
        TaskKill taskKill2 = new TaskKill(ChatColor.YELLOW + "Desert Cavalry Skeleton", 12);
        tasks.add(taskKill2);

        List<ItemStack> itemPrizes = new ArrayList<>();
        String objectiveText = "<Dungeon>\nTASK_PROGRESS_1\nthen talk to Pastry Chef Jasper";
        Quest quest = new Quest(57, "Evil cook", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
        QuestNPCManager.addQuest(quest, 43, 43);
    ...
    private static void createQuestEight() {
        ...
        TaskKill taskKill = new TaskKill(ChatColor.YELLOW + "Selket", 1);
        tasks.add(taskKill);

        List<ItemStack> itemPrizes = new ArrayList<>();
        String objectiveText = "<Dungeon>\nTASK_PROGRESS_1\nthen talk to Pastry Chef Jasper";
        Quest quest = new Quest(58, "Evil cook", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
        QuestNPCManager.addQuest(quest, 43, 43);
    ...
    private static void createQuestNine() {
        ...
        Quest quest = new Quest(59, "Tasteful sugars", story,
                "", objectiveText,
                "", tasks, itemPrizes, 10, 10, 0, requiredQuests,
                Material.GRASS_BLOCK);
